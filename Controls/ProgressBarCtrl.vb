...
<ToolboxBitmap(GetType(ProgressBarCtrl), "SmoothProgressBar.ico"), _
...
#Region " Methods "
    ...
    Protected Overrides Sub OnPaint(ByVal e As PaintEventArgs)
        ...
        Dim brush As Object = New LinearGradientBrush(rectf, mbackcolor1, mbackcolor2, mbackgradientmode)

        ' Draw the background of the ProgressBar control.
        If mbackcolorstyle = ColorStyle.Gradient Then

            brush = New LinearGradientBrush(rectf, mbackcolor1, mbackcolor2, mbackgradientmode)
